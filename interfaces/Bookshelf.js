...
declare class BS$Collection<M: Object, SpecificModel: BS$Model<M>> {
  ...
  static $call(): this;
  constructor(models?: SpecificModel[], options?: { comparator?: bool }): this;
  static extend(prototypeProperties?: Object, classProperties?: Object): BS$Collection<*>;
  add(models: this|$Shape<M>|$Shape<M>[]|SpecificModel|SpecificModel[], options?: { at?: number, merge?: bool }): this;
  ...
  create<A: Object, B: BS$Model<A>>(model: $Shape<A>, options?: BS$TransactionOption): Promise<B>;
  detach(ids?: mixed|mixed[], options?: BS$TransactionOption): Promise<void>;
  fetch(options?: { require?: bool, withRelated?: string | string[] }): Promise<this>;
  fetchOne(options?: { require?: bool, columns?: string | string[], transacting?: Knex$Transaction}): Promise<SpecificModel>;
  findWhere(): SpecificModel;
  get(where: mixed): BS$Model<*>;
  invokeThen(method: string, ...args: mixed[]): Promise<*>;
  load(relations: string | string[], options?: BS$TransactionOption): Promise<this>;
  ...
  reduceThen(iterator: Function, initialValue: mixed, context: Object): Promise<mixed[]>;
  remove<A: SpecificModel|SpecificModel[]>(models: A): A;
  reset(models: SpecificModel | M | SpecificModel[] | M[], options?: { at?: number, merge?: bool }): BS$Model<*>[];
  resetQuery(): this;
  serialize(): M[];
  serialize(options: BS$SerializeOptions): any;
  set(models: M | SpecificModel | M[] | SpecificModel[], options?: { add?: bool, remove?: bool, merge?: bool }): this;
  shift(): this;
  slice(): this;
  through(): this;
  ...
  updatePivot(attributes: Object, options?: { query?: Function|Object, require?: bool, transacting?: Knex$Transaction}): Promise<number>;
  ...
  drop(): any;
  each(): any;
  every(fn: ?(e: SpecificModel) => bool): bool;
  filter(fn: ?(e: SpecificModel) => bool): SpecificModel[];
  find(fn: ?(e: SpecificModel) => bool): ?SpecificModel;
  first(): SpecificModel;
  ...
  shuffle(): any;
  size(): number;
  some(fn: ?(e: SpecificModel) => bool): bool;
  sortBy(): any;
  tail(): any;
  take(): any;
  toArray(): any;
...
declare class BS$Model<T: Object> {
  ...
  attributes: T;
  constructor(attrs: $Shape<T>, options?: { tableName?: string, hasTimestamps?: bool, parse?: bool }): this;
  belongsTo<A, B: Class<A>>(target: B, foreignKey?: string): A;
  belongsToMany<A, B: BS$Model<A>, T: Class<B>>(target: T, foreignKey?: string, otherKey?: string): BS$Collection<A, B>;
  clear(): this;
  clone(): this;
  ...
  has(attribute: $Keys<T>): bool;
  hasChanged(attribute?: $Keys<T>): bool;
  hasMany<A, B: BS$Model<A>, T: Class<B>>(target: T, foreignKey?: string): BS$Collection<A, B>;
  hasOne<A: BS$Model<*>, B: Class<A>>(target: B, foreignKey?: string): A;
  isNew(): bool;
  load(relations: string|string[], options?: { transacting?: Knex$Transaction }): Promise<this>;
  morphMany<A: BS$Model<*>>(target: A, name?: string, columnNames?: string[], morphValue?: string): BS$Collection<A>;
  morphOne<A: BS$Model<*>>(target: A, name?: string, columnNames?: string[], morphValue?: string): A;
  morphTo(name: string, ...target: BS$Model<*>[]): BS$Model<*>;
  morphTo(name: string, columnNames: string[], ...target: BS$Model<*>[]): BS$Model<*>;
  off(eventName?: string): void;
  on(eventName: string, cb: Function): void;
  ...
  through(interim: BS$Model<*>, throughForeignKey?: string, otherKey?: string): BS$Model<*>;
