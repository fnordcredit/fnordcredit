...
declare class KoaRouter$Router {
  ...
  routes(): Function;
  use(...middlewares: ((ctx: KoaRouter$RouterContext, next: Function) => ?Promise<*>)[]): this;
  use(path: string|string[], ...middlewares: ((ctx: KoaRouter$RouterContext, next: Function) => ?Promise<*>)[]): this;
